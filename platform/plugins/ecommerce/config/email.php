...
return [
    ...
    'templates' => array_filter([
        ...
        'quote_request_notification' => [
            'title' => 'plugins/ecommerce::email.quote_request_notification_title',
            'description' => 'plugins/ecommerce::email.quote_request_notification_description',
            'subject' => 'plugins/ecommerce::email.quote_request_notification_subject',
            'can_off' => true,
            'enabled' => true,
            'variables' => [
                'quote_request_id' => 'plugins/ecommerce::quote-requests.quote_request_id',
                'customer_name' => 'plugins/ecommerce::ecommerce.customer_name',
                'customer_email' => 'plugins/ecommerce::ecommerce.customer_email',
                'customer_phone' => 'plugins/ecommerce::ecommerce.customer_phone',
                'company_name' => 'plugins/ecommerce::quote-requests.company',
                'product_name' => 'plugins/ecommerce::products.product_name',
                'product_sku' => 'plugins/ecommerce::products.sku',
                'product_url' => 'plugins/ecommerce::products.product_url',
                'quantity' => 'plugins/ecommerce::quote-requests.quantity',
                'message' => 'plugins/ecommerce::quote-requests.message',
                'status' => 'plugins/ecommerce::quote-requests.status_text',
            ],
        ],
    ]),
];
